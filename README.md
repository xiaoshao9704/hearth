...
Hearth 是壁炉边。以前人们围着炉火坐下说话、听故事；现在几个朋友聚在一间频道里，说话、看同一块画面，就是这件事的数字版。
它是几个朋友的私人客厅，不打算替代 Discord，只做 Discord 做不好或用不了的那一块：画质、延迟、在自己家里跑、数据在自己手里。
...
![30 秒演示：登录、开频道、OBS 推流出画面、双人聊天](site/assets/demo.gif)
...
家庭宽带按「有公网 IPv4 / 只有 IPv6 / CGNAT」分三档，每档要配什么、能用什么、不能用什么，见 [`docs/selfhost-home.md`](docs/selfhost-home.md)。
