...
const PATHS: Record<string, string> = {
  ...
  // 机械齿轮轮廓（齿连成闭环，区别于 sun 的放射线，避免设置键被误认成主题键）
  gear: 'M 16.30 7.71 L 18.25 8.40 L 18.25 11.60 L 16.30 12.29 L 16.07 12.83 L 16.96 14.70 L 14.70 16.96 L 12.83 16.07 L 12.29 16.30 L 11.60 18.25 L 8.40 18.25 L 7.71 16.30 L 7.17 16.07 L 5.30 16.96 L 3.04 14.70 L 3.93 12.83 L 3.70 12.29 L 1.75 11.60 L 1.75 8.40 L 3.70 7.71 L 3.93 7.17 L 3.04 5.30 L 5.30 3.04 L 7.17 3.93 L 7.71 3.70 L 8.40 1.75 L 11.60 1.75 L 12.29 3.70 L 12.83 3.93 L 14.70 3.04 L 16.96 5.30 L 16.07 7.17 Z M 7.50 10.00 a 2.50 2.50 0 1 0 5.00 0 a 2.50 2.50 0 1 0 -5.00 0 Z',
  ...
  // 推流：中心一点 + 两层外扩弧，取「正在往外发」的意思，与 screen（一块屏幕）区分得开
  broadcast:
    'M8.8 10a1.2 1.2 0 1 0 2.4 0a1.2 1.2 0 1 0-2.4 0M6.8 13.2A4.5 4.5 0 0 1 6.8 6.8M13.2 6.8A4.5 4.5 0 0 1 13.2 13.2M4.3 15.7A8 8 0 0 1 4.3 4.3M15.7 4.3A8 8 0 0 1 15.7 15.7',
  ...
  // 钥匙（通行密钥）：圆环 + 一条带齿的柄
  key: 'M12.8 3.2a4 4 0 100 8 4 4 0 000-8M10 10L3.5 16.5M5.5 14.5l1.5 1.5M7.5 12.5l1.5 1.5',
  ...
  clip: 'M15 9.5l-5.4 5.4a3.2 3.2 0 01-4.5-4.5l6.8-6.8a2.1 2.1 0 013 3l-6.8 6.8a1 1 0 01-1.4-1.4l6-6',
  // 信号弱：三格递增柱 + 一道斜杠（名册里标连接质量差）
  signalLow: 'M4.5 15.5v-2.5M10 15.5v-6M15.5 15.5v-9.5M3.5 16.5L16.5 3.5',
